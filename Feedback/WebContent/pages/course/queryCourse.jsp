					...
					<div class="col-md-2">
						<select class="form-control" name="condName" id="condName">
							<option value="courseId"
								${condName == 'courseId'?'selected':''  }>课程ID</option>
							<option value="courseName"
								${condName == 'courseName'?'selected':''  }>课程名</option>
						</select>
					</div>
					<div class="col-md-4">
					...
					<c:if test="${condValue != null && condValue != '' }">
						<div class="col-md-2">
							<a class="btn btn-success"
								href="ccAction_insert?type=2&id=${requestScope.course.courseId }"> <i
			...
			<div class="panel-body">
				<fieldset>
					<div class="form-group">
						<label>课程ID <span style="color: red;">${msg }</span></label> <input
							class="form-control" placeholder="课程ID" type="text"
							value="${requestScope.course.courseId }" readonly="readonly">
					</div>
					<div class="form-group">
						<label>课程名</label> <input class="form-control" placeholder="课程名"
							type="text" value="${requestScope.course.courseName }"
							readonly="readonly">
					</div>
					...
					<div class="form-group">
						...
						<p>
							<select class="form-control" readonly>
								<option value="1"
									${requestScope.course.courseType==1?'selected':'' }>纯理论授课</option>
								<option value="2"
									${requestScope.course.courseType==2?'selected':'' }>理论加上机</option>
								<option value="3"
									${requestScope.course.courseType==3?'selected':'' }>纯上机实践</option>
							</select>
						</p>
					</div>
				</fieldset>
